	...
	<div id="page-wrapper">
		<div class="bg-gray full-row py-5 page-banner">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<h3 class="page-name float-left text-secondary mt-1 mb-0">Forgot Password
							</h3>
					</div>
                    ...
                    <div class="col-lg-12">
                        <div class="w-50 m-auto w-sm-100">
                            <div class="login-form">
                                ...
                                <form  method="post" modelAttribute="password" action="/userdrivease/user/changepass1" class="icon-form">
                                    <div class="form-group email">
                                        <label for="exampleInputEmail1">Email address</label>
                                        <input id="exampleInputEmail1" type="email" path="emailId" name="emailId" class="form-control bg-gray" placeholder="Enter recovery email Id">
                                    </div>
