	...
	<div id="page-wrapper">
		<div class="bg-gray full-row py-5 page-banner">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<h3 class="page-name float-left text-secondary mt-1 mb-0">Enter Otp
							</h3>
					</div>
                    ...
                    <div class="col-lg-12">
                        <div class="w-50 m-auto w-sm-100">
                            <div class="login-form">
                                <h4 class="text-secondary mb-4">Enter OTP </h4>
                                <form  method="post" 
								modelAttribute="cpass" action="/userdrivease/user/checkOtp" class="icon-form">
                                    <div class="form-group">
                                        <input  type="text" path="otp" name="otp" class="form-control bg-gray" placeholder="Enter OTP">
                                    </div>
