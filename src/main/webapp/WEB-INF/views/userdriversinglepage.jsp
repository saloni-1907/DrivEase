				...
				<div class="container">
					<div class="row">
						<div class="col-lg-8">
							<div class="row">
								<div class="col-md-6">
									<h3 class="mt-2 text-secondary">${driverUser.fname}
										${driverUser.lname}</h3>
									<span class="mb-sm-20 d-block"><i
										class="fas fa-map-marker-alt text-primary font-16"></i> &nbsp;
										${driverUser.address}, ${driverUser.areaName},
										${driverUser.cityName}, ${driverUser.stateName}</span>
								</div>
								<div class="col-md-6">
									<span class="d-block text-left text-secondary text-md-right"></span>
									<div class="text-primary text-left my-2 text-md-right">Rent
										per hour: Rs.<span id="perHour">${driver.hourlyRent}</span></div>
									<div class="text-primary text-left my-2 text-md-right">Rent
										per day: Rs.<span id="perDay"> ${driver.dailyRent}</span></div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div id="single-property"
										...
										<div class="ls-slide"
											...
											<img width="900" height="700"
												src="/userdrivease/resources/images/profilePicture/${driverUser.profilePicture}"
												class="ls-bg" alt="" />
										</div>
							...
							<div class="property-details">
								...
								<h2 class="mt-5 mb-4 text-secondary">Driver Details Summary</h2>
								<div class="col-md-12">
									<div
										class="profile-data py-6 pr-6 text-ordinary hover-primary position-relative">
						...
						<div class="col-lg-4">
							...
							<form:form class="d-inline-block w-100" modelAttribute="booking"
								action="/userdrivease/booking/bookDriver" method="post">
								...
								<label class="sr-only" for="inlineFormInputGroupUsername3"><b>Start
										Date And Time</b></label>
								...
								<label class="sr-only" for="inlineFormInputGroupUsername3"><b>End
										Date And Time</b></label>
								<div class="input-group mb-2 mr-sm-2">
										<div class='input-group date' id='endDateTime'>
											<form:input type='text' class="form-control"
												id='endDateTime1' path="endDate" />
											<span class="input-group-addon"> <span
												class="glyphicon glyphicon-calendar"></span>
											</span>
										</div>
								...
								<input class="btn btn-primary mt-8" style="width: 49%;"
									...
									formaction="/userdrivease/booking/bookDriver/${driver.driverId}" />
								<input class="btn btn-primary mt-8" style="width: 49%;"
									type="submit" value="Cancel" formaction="/userdrivease/driver/viewDriver/${driver.driverId}" />
							...
							<div class="mt-4 p-4 shadow-one">
								...
								<form:form class="bg-gray-input d-inline-block" modelAttribute="review"
									action="/userdrivease/review/addReview/Driver/${driver.driverId}"
									method="post">
									<div class="row">
										<br>
										<br>
									...
									id="inlineFormInputGroupUsername3" path="userId" />
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<form:textarea class="form-control" id="review" name="review" path="reviewDesc"
...
============================================================-->
	...
	function findDiff(startDateTimeP, endDateTimeP) {
         ...
         var seconds = Math.round(Math.abs(firstDate - secondDate) / 1000); //calculate the diffrence seconds
