					...
					<div class="col-lg-4">
						<div class="sidebar-widget">
							<h4
								...
								Search</h4>
							<form:form method="post" modelAttribute="driverFilter"
								action="/userdrivease/driver/filterSearch">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<span class ="text-primary">Preferable Vehicle Type</span> <br>
						...
						<div class="sidebar-widget mt-5"></div>
					</div>
									...
									<div class="col-md-6">
										<div class="featured-thumb hover-zoomer mb-4">
											<div class="overlay-black overflow-hidden position-relative">
												<img
													src="/userdrivease/resources/images/profilePicture/${d.profilePicture}"
													height="300" alt="">
											...
											<div class="featured-thumb-data shadow-one">
												<div class="p-4">
													...
													<span class="location"><b>Preferable Vehicle
															Type</b><br>${d.vehicleTypeName}</span>
												</div>
